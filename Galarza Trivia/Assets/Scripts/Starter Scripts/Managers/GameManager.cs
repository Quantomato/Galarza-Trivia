...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    // Start code for adding questions cus this shit is wack

    // Create the Questions for use in the game
    {
        ...
        // Add all of the questions into a list for use in the game
        
        // end wack ass question code
